...
- ServerHub (The hub of serverbee, provide history data from serverbee-web)
  ...
  - serverbee-recorder
- [ServerBee Backend](https://github.com/ZingerLittleBee/server_bee-backend/blob/main/web/README.md) (The backend of serverbee, can be used as a standalone application)
...
- [ServerHub](docs.serverhub.app/hub/introduction)
- [ServerBee](docs.serverbee.app/app/startup/introduction)
...
SEE [CHANGELOG](https://github.com/ZingerLittleBee/server_bee-backend/blob/main/CHANGELOG.md)
